...
class Parser {
     ...
     */
    public const ITT_TEXT   = 'TEXT';
    public const ITT_IT     = 'IT';
    public const ITT_IT2    = 'IT2';
    public const ITT_REF    = 'REF';
    public const ITT_INP    = 'INP';
    public const ITT_MW     = 'MW';
    public const ITT_MAILTO = 'MAILTO';
    public const ITT_HTTP   = 'HTTP';
    public const ITT_HTTPS  = 'HTTPS';
    public const ITT_BTN    = 'BTN';
    public const ITT_FILE   = 'FILE';
    public const ITT_RADIO  = 'RADIO';
    public const ITT_COMBO  = 'COMBO';
    ...
    */
    public function parse(string $parsingText){
    ...
    */
    public function getRecords($prodorderOperationId) {
      $records = [];
      foreach ($this->items as $item)
        $records = $item->getRecord($prodorderOperationId);
    ...
    */
    public function storeItems($prodorderOperationId){
      foreach ($this->items as $item)
        $item->getRecord($prodorderOperationId)->save();
    }
