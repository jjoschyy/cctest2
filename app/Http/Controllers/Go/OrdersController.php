...
class OrdersController extends Controller {
    ...
    public function index(OrdersRepository $ordersRepository) {
        ...
        // get zkms and faufs
        $products = $ordersRepository->getOrders(Auth::user()->id);

        return view('go.orders.index', ['products' => $products, 'userData' => Auth::user(), 'include_css' => ['go/orders.css'],'hideBreadcrumb'=>true]);
    }
