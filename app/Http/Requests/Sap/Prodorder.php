...
class Prodorder {
    ...
    /**
     * Get the validation rules that apply to the sap production order request.
     *
     * @return array
     */
    public static function rules() {
        ...
        return [
                ...
                'Documents.*.DownloadId' => 'required_with:Documents|integer',
                'Documents.*.Title' => 'required_with:Documents|string|max:' . $length,
                'Documents.*.Name' => 'required_with:Documents|string|regex: /^[\w\.-]*$/|max:' . $length,
                'Documents.*.Type' => 'required_with:Documents|string|alpha_num|max:' . $length,
                'Documents.*.Language' => 'required_with:Documents|string|alpha|size:1',
                'NSPs' => 'nullable|array',
                'NSPs.*.OperationNumber' => 'nullable|string|digits:4',
                'NSPs.*.SequenceNo' => 'nullable|string|digits:6',
                'NSPs.*.Title' => 'required_with:NSPs|string|max:' . $length,
                'NSPs.*.Content' => 'required_with:NSPs|string',
                'NSPs.*.Documents' => 'required_with:NSPs|array',
                'NSPs.*.Documents.*.DownloadId' => 'required_with:NSPs|integer',
                'NSPs.*.Documents.*.Title' => 'required_with:NSPs|string|max:' . $length,
                'NSPs.*.Documents.*.Name' => 'required_with:NSPs|string|regex: /^[\w\.-]*$/|max:' . $length,
                'NSPs.*.Documents.*.Type' => 'required_with:NSPs|string|alpha_num|max:' . $length,
                'NSPs.*.Documents.*.Language' => 'required_with:NSPs|string|alpha|size:1',
        ];
    }
...
/*
 * Sample production order 2017-12-08
 */
